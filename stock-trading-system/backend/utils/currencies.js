...
const detectCurrencyFromAcceptLanguage = (acceptLanguage) => {
  ...
  if (first.toLowerCase().startsWith('hi')) return 'INR';
  return 'USD';
};

const isValidCurrency = (code) => CURRENCY_CODES.includes(code);
